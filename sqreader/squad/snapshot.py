...
def resolve_paths(pm: ProcessMemory, arr: GUObjectArray,
    ...
    optional = {
        ...
        **{name: "Class" for name in COLLECTOR_CLASSES.values()},
        ...
        # lists here too, is already resolved above for the firer field.)
    ...
    # Upstream 1.4.5 shifted the two unnamed placer pointers here by the
    # baked-vs-live drift of DEPLOYABLE_OFFSETS["Health"]. That arithmetic is
