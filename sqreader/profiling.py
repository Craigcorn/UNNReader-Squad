...
class _Stats:
    ...
    def _zero(self) -> None:
        ...
        self.syscall_n = 0
        self.region_n = 0
        # Slots the delta walk actually visited this tick (-1 = the
        # pure-Python fallback ran, no count available).
        self.walk_visits = -1
        self.walk_full = False
...
def emit() -> None:
    ...
    print(
        ...
        f"delta={s.walk_visits}{' FULL' if s.walk_full else ''}",
        file=sys.stderr,
    )
