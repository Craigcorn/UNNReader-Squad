...
EXPECTED: list[tuple[str, str, list[str], str]] = [
    ...
    ("CommanderNomineeArray", "ScriptStruct", ["Items"],
     "§3 nominees[] (the FastArray whose Items the nominees sit in)"),
    ("SQCommandActor", "Class",
     ["Distance", "Team", "DamageInstigatorController", "Action"],
     "§6 common fields (the native base every command actor derives from)"),
    ("BP_CommandActor_C", "BlueprintGeneratedClass",
     ["Action Destroyed", "Destroy Delay after Action Destroyed"],
     "§6 common fields (the Blueprint base)"),
...
EXPECTED += [
    ...
    ("BP_CommandActor_Artillery_Radius_C", "BlueprintGeneratedClass",
     ACTOR_COMMON + ARTILLERY, "§6 artillery"),
    ("BP_CommandActor_ArtilleryBase_C", "BlueprintGeneratedClass",
     ARTILLERY, "§6 artillery (the family base that declares the ten)"),
